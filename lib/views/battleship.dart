...
class _BattleshipGameScreenState extends State<BattleshipGameScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Battleship Calculus", style: TextStyle(color: Colors.white)), backgroundColor: Colors.blueGrey),
      body: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text(_xQuestion, style: TextStyle(color: Colors.white, fontSize: 18)),
          Text(_yQuestion, style: TextStyle(color: Colors.white, fontSize: 18)),
          SizedBox(height: 20),
          GridView.builder(
            shrinkWrap: true,
